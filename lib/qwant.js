...
browser.runtime.onInstalled.addListener(function (details) {
    function setCurrentTabUrl(tabsArray) {
        ...
        browser.tabs.create({
            url: "https://www.qwantjunior.com/extension/thanks",
            active: false
        });
    }
    ...
    if (details.reason === "install") {
        browser.tabs.query({active: true}, setCurrentTabUrl);
...
browser.contextMenus.create({
    ...
    onclick : function (info) {
        ...
        browser.tabs.create({
            url: "https://www.qwantjunior.com/?q=" + queryText + "&client=ext-chrome-cm"
        });
    }
});
...
browser.omnibox.onInputEntered.addListener(function (text) {
    browser.tabs.query({
        ...
        browser.tabs.update(tabs[0].id, {
            url: "https://www.qwantjunior.com/?q=" + encodeURIComponent(text) + "&client=ext-chrome-ob"
        });
    });
});
